...
- Demo credentials (Filament admin)
...
seeded · one platform-wide revenue share · UTC day boundaries · payments and refunds are recorded
as captured facts (the gateway executes them) · monthly payout schedule · minimum payout threshold · 7-day hold.
...
|---|---|
| Key architectural decisions | PLAN §4 (D‑1 … D‑10) + refinements in `features/README.md` |
